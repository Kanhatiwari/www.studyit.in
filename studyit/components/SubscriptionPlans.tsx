  ...
  const plans = [
    {
      ...
      features: [
        ...
        { name: 'Task Manager (Basic)', included: true },
        { name: 'Scholarship Exams', included: true, highlight: true },
    ...
    },
    {
      ...
      features: [
        { name: 'Dashboard Access', included: true },
        { name: 'AI Tutor (Standard)', included: true },
        { name: 'Task Manager (Advanced)', included: true, highlight: true },
        { name: 'Scholarship Exams', included: true },
    ...
    },
    {
      ...
      features: [
        ...
        { name: 'Task Manager (Advanced)', included: true },
        { name: 'Scholarship Exams', included: true },
        { name: 'Study Spots (Maps)', included: true },
